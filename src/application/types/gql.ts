import { MemoryInternals } from "./scalars";
...
export type Scalars = {
  ...
  /** Memory internals are a very dynamic type... let's leave that to TS */
  MemoryInternals: { input: MemoryInternals; output: MemoryInternals };
...
export type Query = {
  ...
  memoryInternals: Maybe<Scalars["MemoryInternals"]["output"]>;
...
export type GetMemoryInternalsVariables = Exact<{ [key: string]: never }>;

export type GetMemoryInternals = { memoryInternals: MemoryInternals | null };
