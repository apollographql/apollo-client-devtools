...
type SearchIconProps = Omit<IconProps, "children" | "viewBox">;

export function SearchIcon({ className, size, ...props }: SearchIconProps) {
  return (
    <Icon {...props} viewBox="0 0 24 24" className={className} size={size}>
