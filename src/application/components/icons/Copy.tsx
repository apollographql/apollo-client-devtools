...
type CopyIconProps = Omit<IconProps, "children" | "viewBox">;

export function CopyIcon({ className, size, ...props }: CopyIconProps) {
  return (
    <Icon {...props} viewBox="0 0 24 24" size={size} className={className}>
