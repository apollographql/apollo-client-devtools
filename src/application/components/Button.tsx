...
export function Button({
  ...
  return (
    <button
      ...
      className={clsx(
        className,
        "flex items-center gap-2 focus:ring-3 focus:ring-offset-3 focus:ring-offset-primary focus:dark:ring-offset-primary-dark focus:ring-focused focus:dark:ring-focused-dark",
        {
