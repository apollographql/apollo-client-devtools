...
If you are running Apollo Client 3.0, you must be running at least version 2.3.4 of the dev tools.
...
If you are using Apollo Client 3.0, make sure you are using at least version 2.3.4 of the devtools.
