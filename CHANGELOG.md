...
- [#1449](https://github.com/apollographql/apollo-client-devtools/pull/1449) [`ff3882a`](https://github.com/apollographql/apollo-client-devtools/commit/ff3882a611bc41c751a3f774e63b191d294cf7aa) Thanks [@jerelmiller](https://github.com/jerelmiller)! - Add support for inspecting multiple clients. When multiple clients connect to devtools, you can select which to inspect. When combined with Apollo Client [3.11](https://github.com/apollographql/apollo-client/releases/tag/v3.11.0), you can provide a custom name using the new `devtools` option.
